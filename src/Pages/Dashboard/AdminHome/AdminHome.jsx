        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4 mb-5">
                <div className="p-4 bg-[#36A2EB] flex justify-center items-center flex-col gap-3 rounded-full">
                    <h4 className="text-xl font-bold">Total Biodata</h4>
                    <p className="text-xl font-bold">{dashboardData.totalBiodata}</p>
                </div>
                <div className="p-4 bg-[#FF6384] flex justify-center items-center flex-col gap-3 rounded-full">
                    <h4 className="text-xl font-bold">Male Biodata</h4>
                    <p className="text-xl font-bold">{dashboardData.maleBiodata}</p>
                </div>
                <div className="p-4 bg-[#4BC0C0] flex justify-center items-center flex-col gap-3 rounded-full">
                    <h4 className="text-xl font-bold">Female Biodata</h4>
                    <p className="text-xl font-bold">{dashboardData.femaleBiodata}</p>
                </div>
                <div className="p-4 bg-[#FFCE56] flex justify-center items-center flex-col gap-3 rounded-full">
                    <h4 className="text-xl font-bold">Premium Biodata</h4>
                    <p className="text-xl font-bold">{dashboardData.premiumBiodata}</p>
                </div>
                <div className="p-4 bg-[#9966FF] flex justify-center items-center flex-col gap-3 rounded-full col-span-2">
                    ...
                    <p className="text-xl font-bold">${dashboardData.totalRevenue.toFixed(2)}</p>
                </div>
            </div>
            <div className="p-4 md:w-2/3 mx-auto">
                <h4 className="text-center mb-5 text-xl font-bold text-pink-500">Data Breakdown</h4>
                <Pie data={pieData} />
            </div>
        </div>
    );
