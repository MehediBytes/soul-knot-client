...
//     useEffect(() => {
//         if (favorites) {
//             const userFavoritesBiodata = favorites.find(item => item.userFavorite === user?.email);
//             if (userFavoritesBiodata) {
//                 setFavorite(userFavoritesBiodata);
//             }
//         }
...
//                                 <td className="border border-gray-300 p-2">{favorite.name}</td>
//                                 <td className="border border-gray-300 p-2">{favorite.biodataId}</td>
//                                 <td className="border border-gray-300 p-2">{favorite.permanentDivisionName}</td>
//                                 <td className="border border-gray-300 p-2">{favorite.occupation}</td>
